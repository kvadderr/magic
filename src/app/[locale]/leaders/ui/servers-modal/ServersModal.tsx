...
export const ServersModal = () => {
  ...
  const { serversList, serverId, setServerId, setModal } =
    ...
    <div className="modal modalActive" style={{ zIndex: 100 }}>
      ...
      >
        ...
        <div className="selectServerModal">
                ...
                <Fragment key={id}>
                  ...
                  >
                    ...
                    <input
                      ...
                      name="server"
                      id={id}
                      defaultChecked={serverIdTemp === sv.serverID}
                      readOnly
                    />
          ...
          <button className="btn wideBtn lightBtn" onClick={() => emit()}>
            {t('submit')}
          </button>
        </div>
      </div>
