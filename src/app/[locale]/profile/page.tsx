...
export default async function ProfilePage(props: { searchParams: { tab: string } }) {
  return (
    <div>
        ...
        <div className="container profile-top-container">
          <div className="profile-top_inner">
            <div className="left-side">
              <div className="logo">
                <img src="" alt="" className="avatarInProfile"/>
              </div>
              <div className="user">
                <span className="user-name">ХОЧУ МЕГАН ФОКС</span>
                <Link href="#">
            ...
            <div className="right-side">
              <button className="btn blackBtn exitBtn">
          ...
          <div className="profile-nav">
            <Link href="?tab=inventory"
                  className={`profile-nav__btn ${!props.searchParams.tab || props.searchParams.tab === "inventory" ? "profile-nav__btn__active" : ""}`}>Инвентарь</Link>
            <Link href="?tab=detail"
                  className={`profile-nav__btn ${props.searchParams.tab === "detail" ? "profile-nav__btn__active" : ""}`}>Детализация</Link>
          </div>
        </div>
      </div>
