...
import {serviceModalChangeServerInInventory, serviceModalChangeServerTitle} from "@/shared/constants/modal";
...
const ChangeServer = ({ setSelectedServer, infoOfSelect }: ChangeServerProps) => {
    ...
    return (
        <div className="serverForActivation">
            <span className="serverForActivationTitle">{serviceModalChangeServerTitle.ru}</span>
