...
import {
    serviceInfoModalManyHours,
    serviceInfoModalOneHour,
    serviceInfoModalTwoHours,
...
export const ModalCardContent = ({
    ...
    const sendData = async () => {
        ...
        try {
            ...
            if (res.status === 200) {
                console.log("Purchase successful, reloading page...");
                window.location.reload();
            } else {
                const errorMessage = res.data.message || t("purchase_failed");
                alert(errorMessage);
            }
        } catch (error) {
    ...
    return (
        <div
            ref={ref}
            className="modalContent mountedStyle serviceModal modalContentActive">
                ...
                <div className="serviceModalLeftInfo">
                    <div className="serviceModalLeftInfoBlock">
                        <div className="serviceModalLeftInfoItem">
                            <h4 className="serviceModalLeftInfoItemTitle">{t("rates")}</h4>
                            <span className="serviceModalLeftInfoItemCount">
                x{product.productContent.rade}
              </span>
                        </div>
                        <div className="serviceModalLeftInfoItem">
                            <h4 className="serviceModalLeftInfoItemTitle">{t("delay")}</h4>
                            <span className="serviceModalLeftInfoItemCount">
                {product.productContent.delay} с
              </span>
                        </div>
                        <div className="serviceModalLeftInfoItem">
                            <h4 className="serviceModalLeftInfoItemTitle">{t("home")}</h4>
                            <span className="serviceModalLeftInfoItemCount">
                +{product.productContent.setHome}
              </span>
                        </div>
                    </div>
                </div>
            ...
            <div className="serviceModalRight">
                ...
                +{product.productContent.setHome}
                    ...
                    <div className="serviceModalRightContent">
                        ...
                        {product.productContent.data.map((el, ind) => (
                            <div className="serviceItem" key={ind}>
                                    ...
                                    {el.time && (
                                        <div className="serviceItemTimer">
                                            ...
                                            <p>
                                                ...
                                                {
                                                    lang !== "ru" &&el.time + " " + getCase(el.time, [
                                                        serviceInfoModalOneHour.en,
                                                        serviceInfoModalTwoHours.en,
                                                        serviceInfoModalManyHours.en,
                                                    ])
                                                }
                                            </p>
                                        </div>
                                ...
                                <div className="serviceItemContainer">
                                    {el.itemData.map((subEl, subInd) => (
                                        <div className="serviceItemElem" key={subInd}>
                                            <img src={subEl.image} alt=""/>
                                            <span className="serviceItemElemCount">
                        x{subEl.amount}
                      </span>
                                        </div>
                                    ))}
                    ...
                    <ChangeServer
                        ...
                        infoOfSelect={servers}
                    />
                    <button
                        className="btn lightBtn wideBtn"
                        style={{fontWeight: 600, fontSize: "16px", lineHeight: "16px"}}
                        onClick={() => sendData()}>
