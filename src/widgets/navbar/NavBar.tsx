...
import { PlusBalanceIcon } from '@/shared/assets';
...
const Navbar = () => {
  ...
  const asyncData = async (token: string) => {
    const {
      data: { balance },
    } = await UserApi.getBalance(token);
        ...
        <div className="container">
          <div className="header_inner">
            ...
            <nav className="navbar">
              <Link locale={locale} href="/servers" className="navbar__item">
                <Image
              ...
              <Link locale={locale} href="/info" className="navbar__item">
                <Image
              ...
              <Link locale={locale} href="/leaders" className="navbar__item">
                <Image
              ...
              <Link locale={locale} href="/banlist" className="navbar__item">
                <Image
